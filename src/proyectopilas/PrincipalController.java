...
public class PrincipalController implements Initializable {
    ...
    private void actionevent (ActionEvent e){
        ...
        if(evt.equals(promedio)){
            JOptionPane.showMessageDialog(null, "El promedio del precio de los productos es:\n"
                                                + lista.promedio());
        }
        if(evt.equals(mayorpromedio)){
            lista.mayorpromedio();
        }
        if(evt.equals(menorpromedio)){
            lista.menorpromedio();
        }
        if(evt.equals(mayorprecio)){
            lista.mayorprecio();
        }
        if(evt.equals(menorprecio)){
            lista.menorprecio();
        }
